...
export const portafolioData = [
	{
		imgSrc: '../../../public/img/project.png',
		title: 'Online shop',
		skills: ['Bootstrap', 'CSS', 'JavaScript'],
		descripcion:
				'It is an online shop ARIAL which sells the art works.',
		// demoURL: '',
		// repoURL: '',
		anim: 'fade-right',
	},
	{
		imgSrc: '../../../public/img/todo.png',
		title: 'To_Do List',
		skills: ['JavaScript', 'CSS'],
		descripcion:
				'To note all your tasks, and to delete them when you finish.',
		// demoURL: '',
		// repoURL: '',
		anim: 'fade-up',
	...
	{
		imgSrc: '../../../public/img/port.png',
		title: 'Portfolio',
		skills: ['Bootstrap', 'CSS'],
		descripcion:
			'This is a portfolio about me that I made it in my fist year of university.',
		// demoURL: '',
		// repoURL: '',
		anim: 'fade-left',
	},
